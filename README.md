...
You can use an LLM to help you write your extension. To support this, we've included a [`CLAUDE.md`](AGENTS.md) file and supporting [documentation](./docs) that provide essential context for the model.
